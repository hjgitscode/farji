...
// A canonicalised, deterministically-ordered view of the claim. This is
// exactly the shape lib/crypto/canonicalisation will hash from Phase 3/4
// onward — shown here as a preview so the demo can foreshadow that step.
          ...
          <Card key={credential.credentialId}>
            ...
            <details className="mt-3">
              <summary className="cursor-pointer text-xs font-medium text-brand">
                Preview canonical credential + hash
              </summary>
              ...
              <p className="mt-2 font-mono text-xs text-slate-500">
                Keccak-256 (Phase 4 preview): {truncateHex(placeholderHex(credential.credentialId))}
              </p>
            </details>
          </Card>
        );
